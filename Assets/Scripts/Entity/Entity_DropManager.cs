...
public class Entity_DropManager : MonoBehaviour
{
    ...
    public Vector3? dropPositionOverride;
    ...
    protected Object_itemPickup CreateItemDrop(Item_DataSO itemToDrop)
    {
        Vector3 spawnPos = dropPositionOverride ?? transform.position;
