...
public class UI_Dialogue : MonoBehaviour
{
    ...
    [SerializeField] private string typingSoundName = "dialogue_typing";
    ...
    private void HandleNextAction()
    {
        ...
        {
            case DialogueActionType.OpenShop: ui.SwitchToInGameUI(); ui.OpenMerchantUI(true);
                break;
            case DialogueActionType.PlayerMakeChoice:
                ...
                break;
            case DialogueActionType.OpenStorage: ui.SwitchToInGameUI(); ui.OpenStorageUI(true);
                break;
            case DialogueActionType.CloseDialogue: ui.SwitchToInGameUI();
                break;
            case DialogueActionType.OpenControlsUI: ui.OpenControlsUI(); 
                break;
        }
    }
    ...
    private IEnumerator TypeTextCo(string text)
    {
        ...
        foreach (char letter in text)
        {
            ...
            if (letter != ' ')
                AudioManager.instance.PlayGlobalSFX(typingSoundName);
