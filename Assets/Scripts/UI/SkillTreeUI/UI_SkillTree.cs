...
public class UI_SkillTree : MonoBehaviour, ISaveable
{
    ...
    {
        skillPointsText.text = $"Pontos de habilidade: {skillPoints.ToString()}";
    }
    ...
    {
        UI_TreeNode[] skillsNodes = GetComponentsInChildren<UI_TreeNode>();
    ...
    public void LoadData(GameData data)
    {
        ...
        foreach (var skill in skillManager.allSkills)
        {
            ...
            {
                if (upgradeType == SkillUpgradeType.None) continue;
